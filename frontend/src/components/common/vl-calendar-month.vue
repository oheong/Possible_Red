<template>
  <div class="vl-calendar-month">
    <div class="vl-calendar-month__title">{{ monthName }} {{ year }}</div>
...
<script>
import { createRange, transpose } from "../cal_utils/CollectionUtils";
import {
  countDays,
  formatDate,
  getMonthName,
  getWeekNumbers,
} from "../cal_utils/DatesUtils";
import { DAYS_NAMES, DAYS_SHORTCUTS } from "../cal_utils/days";
